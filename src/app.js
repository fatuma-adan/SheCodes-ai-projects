...
function generateJewels(event) {
  ...
  let context =
    "You are a knowledgable jewelry expert and love to style up people. You mission is to generate a unique design in basic HTML and separate each line with a <br />. Make sure to follow the user instructions. Do not include a title to the jewelry. Sign the jewelry with 'SheCodes AI' inside a <strong> element at the end of the Jewelryand NOT at the beginning";
